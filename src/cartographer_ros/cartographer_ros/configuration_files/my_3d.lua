...
-- TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 5e1
-- TRAJECTORY_BUILDER_3D.ceres_scan_matcher.rotation_weight =  1e1

MAP_BUILDER.use_trajectory_builder_3d = true
MAP_BUILDER.num_background_threads = 4 --7
POSE_GRAPH.optimization_problem.huber_scale = 5e2
POSE_GRAPH.optimize_every_n_nodes = 20 --320
POSE_GRAPH.constraint_builder.sampling_ratio = 0.35
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 10 --10
POSE_GRAPH.constraint_builder.min_score = 0.42 --0.62
